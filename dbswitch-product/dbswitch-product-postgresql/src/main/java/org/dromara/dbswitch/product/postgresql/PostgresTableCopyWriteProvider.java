...
import org.dromara.dbswitch.product.postgresql.copy.row.SimpleRow;
import org.dromara.dbswitch.product.postgresql.copy.row.SimpleRowWriter;
...
import org.dromara.dbswitch.product.postgresql.copy.row.SimpleRowWriter.Table;
...
public class PostgresTableCopyWriteProvider extends DefaultTableDataWriteProvider {
  ...
  public PostgresTableCopyWriteProvider(ProductFactoryProvider factoryProvider) {
  ...
  public long write(List<String> fieldNames, List<Object[]> recordValues) {
    ...
    Table table = new Table(schemaName, tableName, columnNames);
