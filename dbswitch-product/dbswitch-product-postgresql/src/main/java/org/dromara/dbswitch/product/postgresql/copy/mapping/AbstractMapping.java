package org.dromara.dbswitch.product.postgresql.copy.mapping;

import org.dromara.dbswitch.product.postgresql.copy.function.ToBooleanFunction;
import org.dromara.dbswitch.product.postgresql.copy.function.ToFloatFunction;
import org.dromara.dbswitch.product.postgresql.copy.model.ColumnDefinition;
import org.dromara.dbswitch.product.postgresql.copy.model.TableDefinition;
import org.dromara.dbswitch.product.postgresql.copy.pgsql.PgBinaryWriter;
import org.dromara.dbswitch.product.postgresql.copy.pgsql.constants.DataType;
import org.dromara.dbswitch.product.postgresql.copy.pgsql.constants.ObjectIdentifier;
import org.dromara.dbswitch.product.postgresql.copy.pgsql.handlers.CollectionValueHandler;
import org.dromara.dbswitch.product.postgresql.copy.pgsql.handlers.IValueHandler;
import org.dromara.dbswitch.product.postgresql.copy.pgsql.handlers.IValueHandlerProvider;
import org.dromara.dbswitch.product.postgresql.copy.pgsql.handlers.RangeValueHandler;
import org.dromara.dbswitch.product.postgresql.copy.pgsql.handlers.ValueHandlerProvider;
...
import org.dromara.dbswitch.product.postgresql.copy.pgsql.model.geometric.Line;
...
import org.dromara.dbswitch.product.postgresql.copy.pgsql.model.range.Range;
...
public abstract class AbstractMapping<TEntity> {
  ...
  protected <TElementType, TCollectionType extends Collection<TElementType>> void mapCollection(
      String columnName, DataType dataType, Function<TEntity, TCollectionType> propertyGetter) {
  ...
  protected <TProperty> void map(String columnName, DataType dataType,
  ...
  protected <TProperty> void map(String columnName, IValueHandler<TProperty> valueHandler,
      Function<TEntity, TProperty> propertyGetter) {
  ...
  protected void mapTimeStampTz(String columnName,
  ...
  protected void mapHstore(String columnName,
  ...
  protected void mapBooleanArray(String columnName,
  ...
  protected <TElementType> void mapRange(String columnName, DataType dataType,
  ...
  protected void mapDateRange(String columnName,
