...
@Product(ProductTypeEnum.UXDB)
public class UxdbFactoryProvider extends AbstractFactoryProvider {

  public UxdbFactoryProvider(DataSource dataSource) {
    super(dataSource);
  }
  ...
  public TableDataWriteProvider createTableDataWriteProvider(boolean useInsert) {
    return useInsert
        ...
        : new UxdbTableCopyWriteProvider(this);
  }
